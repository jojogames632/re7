...
class ShoppingController extends AbstractController
{
     ...
     */
    public function index(PlanningRepository $planningRepository, RecipeFoodRepository $recipeFoodRepository, FoodRepository $foodRepository, string $planningOwner = 'Christophe'): Response
    { 
